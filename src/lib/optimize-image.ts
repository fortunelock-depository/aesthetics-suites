...
//
// Client-side photo downscaling, shared by the admin upload fields.
//
// Phone cameras produce 4-12MB images the site renders at ~1200px at most;
// shrinking them in the browser before staging turns a minutes-long upload
// on a mobile connection into seconds and keeps the server's Cloudinary call
// well inside its timeout. Any decode failure (e.g. HEIC on a browser that
